...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DemoDemo = __webpack_require__(158);

	var _DemoDemo2 = _interopRequireDefault(_DemoDemo);

	var _SharedHeaderHeader = __webpack_require__(201);

	var _SharedHeaderHeader2 = _interopRequireDefault(_SharedHeaderHeader);

	var _SharedDocumentDocumentScss = __webpack_require__(205);

	var _SharedDocumentDocumentScss2 = _interopRequireDefault(_SharedDocumentDocumentScss);

	_reactDom2['default'].render(_react2['default'].createElement(_SharedHeaderHeader2['default'], null), document.getElementById('header'));
	_reactDom2['default'].render(_react2['default'].createElement(_DemoDemo2['default'], null), document.getElementById('main'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WindowOsx = __webpack_require__(159);

	var _WindowOsx2 = _interopRequireDefault(_WindowOsx);

	var _WindowWindows = __webpack_require__(191);

	var _WindowWindows2 = _interopRequireDefault(_WindowWindows);

	var _SharedOsToggleOsToggle = __webpack_require__(194);

	var _SharedOsToggleOsToggle2 = _interopRequireDefault(_SharedOsToggleOsToggle);

	var _DemoScss = __webpack_require__(199);

	var _DemoScss2 = _interopRequireDefault(_DemoScss);
	  ...
	  _createClass(_default, [{
	    ...
	    value: function render() {
	      ...
	      if (this.state.os === 'osx') {
	        window = _react2['default'].createElement(
	          'div',
	          { key: 'osx' },
	          _react2['default'].createElement(_WindowOsx2['default'], null)
	        );
	      } else {
	        window = _react2['default'].createElement(
	          'div',
	          { key: 'win' },
	          _react2['default'].createElement(_WindowWindows2['default'], null)
	        );
	      }
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { className: 'demo' },
	        _react2['default'].createElement(_SharedOsToggleOsToggle2['default'], { onChange: this.changeOs.bind(this) }),
	        window
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDesktopLibOSX = __webpack_require__(160);
	...
	var _default = (function (_Component) {
	  ...
	  _createClass(_default, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        _reactDesktopLibOSX.Window,
	        { chrome: true },
	        _react2['default'].createElement(
	          _reactDesktopLibOSX.TitleBar,
	          { title: 'TitleBar with Toolbar', controls: true },
	          _react2['default'].createElement(_reactDesktopLibOSX.Toolbar, null)
	        ),
	        _react2['default'].createElement(
	          _reactDesktopLibOSX.Box,
	          { className: 'box' },
	          _react2['default'].createElement(
	            _reactDesktopLibOSX.SegmentedControl,
	            null,
	            _react2['default'].createElement(
	              _reactDesktopLibOSX.SegmentedControl.Item,
	              {
	                title: 'Segmented',
	              ...
	              _react2['default'].createElement(
	                _reactDesktopLibOSX.Form,
	                { onSubmit: this.submit.bind(this) },
	                _react2['default'].createElement(
	                  _reactDesktopLibOSX.Label,
	                  { ref: 'error', color: 'red', align: 'center', display: false },
	                  'There was an error submitting this form.'
	                ),
	                _react2['default'].createElement(
	                  _reactDesktopLibOSX.Form.Row,
	                  null,
	                  _react2['default'].createElement(
	                    _reactDesktopLibOSX.Label,
	                    null,
	                  ...
	                  _react2['default'].createElement(_reactDesktopLibOSX.TextField, { defaultValue: '', placeholder: 'TextField', style: { width: '200px' } })
	                ),
	                _react2['default'].createElement(
	                  _reactDesktopLibOSX.Form.Row,
	                  null,
	                ...
	                _react2['default'].createElement(
	                  ...
	                  null,
	                  _react2['default'].createElement(
	                    _reactDesktopLibOSX.PushButton,
	                  ...
	                  _react2['default'].createElement(_reactDesktopLibOSX.IndeterminateCircularProgressIndicator, { ref: 'loader', absolute: true, visible: false })
	                )
	              )
	            ),
	            _react2['default'].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TitleBar = __webpack_require__(165);
	exports.TitleBar = TitleBar;
	var Toolbar = __webpack_require__(178);
	exports.Toolbar = Toolbar;
	var PushButton = __webpack_require__(179);
	exports.PushButton = PushButton;
	var TextField = __webpack_require__(180);
	exports.TextField = TextField;
	var Box = __webpack_require__(181);
	exports.Box = Box;
	var SegmentedControl = __webpack_require__(182);
	exports.SegmentedControl = SegmentedControl;
	var IndeterminateCircularProgressIndicator = __webpack_require__(186);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Styling = __webpack_require__(162);

	var _Styling2 = _interopRequireDefault(_Styling);

	var _TitleBar = __webpack_require__(163);

	var _TitleBar2 = _interopRequireDefault(_TitleBar);

	var _TitleBarTitleBarOsx = __webpack_require__(165);

	var _TitleBarTitleBarOsx2 = _interopRequireDefault(_TitleBarTitleBarOsx);
	...
	var styles = {
	  osx_10_11: {
	    ...
	    chrome: {
	      ...
	      boxShadow: '0 0 1px rgba(0, 0, 0, .5), ' + // Border
	      '0 15px 25px rgba(0, 0, 0, .1), ' + '0 0 30px rgba(0, 0, 0, .06), ' + '0 0 60px rgba(0, 0, 0, .06)'
	    },
	...
	var WindowOSX = (function (_Component) {
	  _inherits(WindowOSX, _Component);

	  _createClass(WindowOSX, null, [{
	    key: 'propTypes',
	    value: {
	      children: _react.PropTypes.oneOfType([_react2['default'].PropTypes.string, _react2['default'].PropTypes.element, _react2['default'].PropTypes.array]),
	  ...
	  function WindowOSX(props) {
	    _classCallCheck(this, WindowOSX);

	    _get(Object.getPrototypeOf(WindowOSX.prototype), 'constructor', this).call(this);
	    this.state = { visible: props.visible !== false, display: props.display !== false };
	  }

	  _createClass(WindowOSX, [{
	    key: 'render',
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['style', 'chrome', 'children', 'visible', 'display']);

	      var styles = this.styles;
	      if (chrome) {
	        styles = (0, _Styling.mergeStyles)(styles, this.styles.chrome);
	      }

	      var titleBar = _react.Children.map(children, (function (element, index) {
	        if (element.type === _TitleBar2['default'] || element.type === _TitleBarTitleBarOsx2['default']) {
	          return element;
	        }
	      }).bind(this));

	      children = _react.Children.map(children, (function (element, index) {
	        if (element.type !== _TitleBar2['default'] && element.type !== _TitleBarTitleBarOsx2['default']) {
	          return element;
	        }
	      }).bind(this));
	      ...
	      if (!this.state.visible) {
	        styles = (0, _Styling.mergeStyles)(styles, { visibility: 'hidden' });
	      } else {
	        styles = (0, _Styling.mergeStyles)(styles, { visibility: 'visible' });
	      }

	      if (!this.state.display) {
	        styles = (0, _Styling.mergeStyles)(styles, { display: 'none' });
	      } else {
	        styles = (0, _Styling.mergeStyles)(styles, { display: 'flex' });
	      }

	      return _react2['default'].createElement(
	        'div',
	        _extends({ style: (0, _Styling.applyStyle)(styles) }, props),
	        titleBar,
	        _react2['default'].createElement(
	          'div',
	          { style: (0, _Styling.applyStyle)(this.styles.content) },
	          children
	        )
	      );
	    }
	    ...
	    key: 'styles',
	    get: function get() {
	      return (0, _Styling.mergeStyles)(styles.osx_10_11, this.props.style);
	    }
	  }]);
	  ...
	  return (function (_Component) {
	    ...
	    _createClass(_class, [{
	      ...
	      value: function applyInlineStyles() {
	        var states = [':hover', ':active', ':focus', ':placeholder'];
	      ...
	      key: 'applyPropStyles',
	      value: function applyPropStyles() {
	        var states = ['hover', 'active', 'focus', 'hover-selector', 'active-selector', 'focus-selector'];
	        if (this.refs.component.refs.element) {
	          var element = _reactDom2['default'].findDOMNode(this.refs.component.refs.element);
	          var id = element.getAttribute('data-reactid');
	          ...
	          try {
	            for (var _iterator3 = states[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	              ...
	              var attrName = 'data-' + state + '-style';
	              var style = element.getAttribute(attrName);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TitleBarTitleBarWindows = __webpack_require__(172);

	var _TitleBarTitleBarWindows2 = _interopRequireDefault(_TitleBarTitleBarWindows);
	...
	var TitleBar = (function (_Component) {
	  ...
	  _createClass(TitleBar, [{
	    ...
	    value: function render() {
	      if (_Desktop.OS === 'win') {
	        return _react2['default'].createElement(_TitleBarTitleBarWindows2['default'], this.props);
	      } else {
	        return _react2['default'].createElement(_TitleBarTitleBarOsx2['default'], this.props);
	      }
	    }
	  }], [{
	    key: 'propTypes',
	    value: {
	      ...
	      onClosePress: _react.PropTypes.func,
	      onMinimizePress: _react.PropTypes.func,
	      onMaximizePress: _react.PropTypes.func,
	      onResizePress: _react.PropTypes.func,
	      visible: _react.PropTypes.bool,
	      display: _react.PropTypes.bool
	    },
	    enumerable: true
...
/***/ function(module, exports) {
	...
	var Desktop = (function () {
	  ...
	  _createClass(Desktop, null, [{
	    key: 'OS',
	    value: (function () {
	      // explicitly set these to avoid issues
	      var window = window || null;
	      var navigator = navigator || null;
	      var process = process || window ? window.process : null || null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WindowState = __webpack_require__(166);
	...
	var _ControlsOsxControls = __webpack_require__(167);

	var _ControlsOsxControls2 = _interopRequireDefault(_ControlsOsxControls);
	...
	var TitleBarOSX = (function (_Component) {
	  _inherits(TitleBarOSX, _Component);

	  _createClass(TitleBarOSX, null, [{
	    key: 'propTypes',
	    value: {
	      children: _react.PropTypes.oneOfType([_react2['default'].PropTypes.string, _react2['default'].PropTypes.element, _react2['default'].PropTypes.array]),
	      style: _react.PropTypes.object,
	  ...
	  function TitleBarOSX(props) {
	    _classCallCheck(this, _TitleBarOSX);

	    _get(Object.getPrototypeOf(_TitleBarOSX.prototype), 'constructor', this).call(this);
	    this.state = { windowFocused: true, visible: props.visible !== false, display: props.display !== false };
	  }

	  _createClass(TitleBarOSX, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props;
	      var children = _props.children;
	      ...
	      var props = _objectWithoutProperties(_props, ['children', 'controls', 'title', 'visible', 'display']);

	      var styles = this.styles;
	      if (children) {
	        styles = (0, _Styling.mergeStyles)(styles, this.styles.toolbar);
	      }

	      var titleStyle = this.styles.title;
	      if (this.props.controls) {
	        titleStyle = Object.assign(titleStyle, { paddingRight: '60px' });
	      }

	      if (!this.state.windowFocused) {
	        styles = (0, _Styling.mergeStyles)(styles, this.styles.unfocused);
	        titleStyle = (0, _Styling.mergeStyles)(titleStyle, this.styles.title.unfocused);
	      }

	      controls = !controls || _react2['default'].createElement(_ControlsOsxControls2['default'], this.props);
	      ...
	      return _react2['default'].createElement(
	        ...
	        _extends({
	          ...
	          style: (0, _Styling.applyStyle)(styles)
	        }),
	        controls,
	        title,
	        children
	  ...
	  var _TitleBarOSX = TitleBarOSX;
	  TitleBarOSX = (0, _Styling2['default'])(TitleBarOSX) || TitleBarOSX;
	  TitleBarOSX = (0, _WindowState2['default'])(TitleBarOSX) || TitleBarOSX;
	  return TitleBarOSX;
	})(_react.Component);

	exports['default'] = TitleBarOSX;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Minimize = __webpack_require__(170);

	var _Minimize2 = _interopRequireDefault(_Minimize);

	var _Resize = __webpack_require__(171);
	...
	var Controls = (function (_Component) {
	  ...
	  _createClass(Controls, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { style: this.styles, onMouseEnter: this.mouseEnter.bind(this), onMouseLeave: this.mouseLeave.bind(this) },
	        _react2['default'].createElement(_Close2['default'], { onClick: this.props.onClosePress, ref: 'close' }),
	        _react2['default'].createElement(_Minimize2['default'], { onClick: this.props.onMinimizePress, ref: 'minimize' }),
	        _react2['default'].createElement(_Resize2['default'], { onClick: this.props.onResizePress, ref: 'resize' })
	      );
	    }
	  }, {
	    key: 'styles',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Close = (function (_Component) {
	  ...
	  function Close() {
	    _classCallCheck(this, _Close);

	    _get(Object.getPrototypeOf(_Close.prototype), 'constructor', this).call(this);
	  ...
	  _createClass(Close, [{
	    ...
	    value: function render() {
	      ...
	      var displayIcon = this.state.iconVisible ? { opacity: 1 } : { opacity: 0 };
	      var iconStyle = Object.assign({}, this.styles.icon, displayIcon);

	      var styles = this.styles;
	      if (!this.state.windowFocused && !this.state.iconVisible) {
	        styles = (0, _Styling.mergeStyles)(styles, styles.unfocused);
	      }
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'svg',
	          { x: '0px', y: '0px', viewBox: '0 0 6.4 6.4', style: iconStyle },
	  ...
	  var _Close = Close;
	  Close = (0, _Styling2['default'])(Close) || Close;
	  Close = (0, _WindowState2['default'])(Close) || Close;
	  Close = (0, _Button2['default'])(Close) || Close;
	  return Close;
	})(_react.Component);
	...
	function button(ComposedComponent) {
	  return (function (_Component) {
	    ...
	    _createClass(_class, [{
	      ...
	      key: 'render',
	      value: function render() {
	        return _react2['default'].createElement(ComposedComponent, _extends({ ref: 'component', style: this.styles }, this.props));
	      }
	    }, {
	      key: 'styles',
	      get: function get() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Minimize = (function (_Component) {
	  ...
	  function Minimize() {
	    _classCallCheck(this, _Minimize);

	    _get(Object.getPrototypeOf(_Minimize.prototype), 'constructor', this).call(this);
	    this.state = { iconVisible: false, windowFocused: true };
	  }
	  ...
	  _createClass(Minimize, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'svg',
	          { x: '0px', y: '0px', viewBox: '0 0 8 1.1', style: iconStyle },
	  ...
	  var _Minimize = Minimize;
	  Minimize = (0, _Styling2['default'])(Minimize) || Minimize;
	  Minimize = (0, _WindowState2['default'])(Minimize) || Minimize;
	  Minimize = (0, _Button2['default'])(Minimize) || Minimize;
	  return Minimize;
	})(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Resize = (function (_Component) {
	  ...
	  function Resize() {
	    _classCallCheck(this, _Resize);

	    _get(Object.getPrototypeOf(_Resize.prototype), 'constructor', this).call(this);
	    this.state = { iconVisible: false, windowFocused: true };
	  }
	  ...
	  _createClass(Resize, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'svg',
	          { x: '0px', y: '0px', viewBox: '0 0 6 5.9', style: iconStyle },
	  ...
	  var _Resize = Resize;
	  Resize = (0, _Styling2['default'])(Resize) || Resize;
	  Resize = (0, _WindowState2['default'])(Resize) || Resize;
	  Resize = (0, _Button2['default'])(Resize) || Resize;
	  return Resize;
	})(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ControlsWindowsControls = __webpack_require__(173);

	var _ControlsWindowsControls2 = _interopRequireDefault(_ControlsWindowsControls);
	...
	var TitleBarWindows = (function (_Component) {
	  _inherits(TitleBarWindows, _Component);

	  _createClass(TitleBarWindows, null, [{
	    key: 'propTypes',
	    value: {
	      children: _react.PropTypes.oneOfType([_react2['default'].PropTypes.string, _react2['default'].PropTypes.element, _react2['default'].PropTypes.array]),
	      style: _react.PropTypes.object,
	  ...
	  function TitleBarWindows(props) {
	    _classCallCheck(this, _TitleBarWindows);

	    _get(Object.getPrototypeOf(_TitleBarWindows.prototype), 'constructor', this).call(this);
	    this.state = {
	      windowFocused: true,
	  ...
	  _createClass(TitleBarWindows, [{
	    ...
	    value: function render() {
	      ...
	      controls = !controls || _react2['default'].createElement(_ControlsWindowsControls2['default'], this.props);
	      title = !title || _react2['default'].createElement(
	        'div',
	        { style: titleStyle },
	        this.props.title
	    ...
	    key: 'styles',
	    get: function get() {
	      return (0, _Styling.mergeStyles)(styles.windows_10, this.props.style);
	    }
	  }]);

	  var _TitleBarWindows = TitleBarWindows;
	  TitleBarWindows = (0, _Styling2['default'])(TitleBarWindows) || TitleBarWindows;
	  TitleBarWindows = (0, _WindowState2['default'])(TitleBarWindows) || TitleBarWindows;
	  return TitleBarWindows;
	})(_react.Component);

	exports['default'] = TitleBarWindows;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Close = __webpack_require__(174);

	var _Close2 = _interopRequireDefault(_Close);

	var _Minimize = __webpack_require__(176);

	var _Minimize2 = _interopRequireDefault(_Minimize);

	var _Maximize = __webpack_require__(177);
	  ...
	  _createClass(Controls, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        { style: this.styles },
	        _react2['default'].createElement(_Minimize2['default'], { onClick: this.props.onMinimizePress, ref: 'minimize' }),
	        _react2['default'].createElement(_Maximize2['default'], { onClick: this.props.onMaximizePress, ref: 'maximize' }),
	        _react2['default'].createElement(_Close2['default'], { onClick: this.props.onClosePress, ref: 'close' })
	      );
	    }
	  }, {
	...
	var Close = (function (_Component) {
	  ...
	  _createClass(Close, [{
	    ...
	    value: function render() {
	      ...
	      var styles = this.styles;
	      var iconStyle = this.styles.icon;
	      var svgFill = '#000000';
	      if (!this.state.windowFocused) {
	        styles = (0, _Styling.mergeStyles)(styles, this.styles.unfocused);
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'svg',
	          { x: '0px', y: '0px', viewBox: '0 0 10.2 10.2', style: (0, _Styling.applyStyle)(iconStyle) },
	  ...
	  _createClass(Minimize, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'svg',
	          { x: '0px', y: '0px', viewBox: '0 0 10.2 1', style: (0, _Styling.applyStyle)(iconStyle) },
	...
	var Toolbar = (function (_Component) {
	  ...
	  _createClass(Toolbar, [{
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['style', 'visible', 'display']);
	      ...
	      if (!this.state.display) {
	        ...
	        styles = (0, _Styling.mergeStyles)(styles, { display: 'block' });
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PushButton = (function (_Component) {
	  _inherits(PushButton, _Component);

	  _createClass(PushButton, null, [{
	    key: 'propTypes',
	    value: {
	      children: _react.PropTypes.oneOfType([_react2['default'].PropTypes.string, _react2['default'].PropTypes.element, _react2['default'].PropTypes.array]).isRequired,
	      form: _react.PropTypes.any,
	      color: _react.PropTypes.string,
	      style: _react.PropTypes.object,
	      onClick: _react.PropTypes.func,
	      onPress: _react.PropTypes.oneOfType([_react2['default'].PropTypes.string, _react2['default'].PropTypes.func]),
	      visible: _react.PropTypes.bool,
	      display: _react.PropTypes.bool
	    },
	    enumerable: true
	  ...
	  function PushButton(props) {
	    ...
	    _get(Object.getPrototypeOf(_PushButton.prototype), 'constructor', this).call(this);
	    this.state = { windowFocused: true, visible: props.visible !== false, display: props.display !== false };
	  }
	  ...
	  _createClass(PushButton, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      if (_reactDom2['default'].findDOMNode(this).previousSibling) {
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['children', 'color', 'onPress', 'form', 'display', 'visible']);
	  ...
	  PushButton = (0, _Styling2['default'])(PushButton) || PushButton;
	  PushButton = (0, _WindowState2['default'])(PushButton) || PushButton;
	  return PushButton;
	})(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextField = (function (_Component) {
	  ...
	  function TextField(props) {
	    _classCallCheck(this, _TextField);

	    _get(Object.getPrototypeOf(_TextField.prototype), 'constructor', this).call(this);
	    this.state = { visible: props.visible !== false, display: props.display !== false };
	  }
	  ...
	  _createClass(TextField, [{
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['form', 'style', 'visible', 'display']);
	  ...
	  TextField = (0, _Styling2['default'])(TextField) || TextField;
	  return TextField;
	})(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SegmentedControl = __webpack_require__(182);
	...
	var Box = (function (_Component) {
	  ...
	  _createClass(Box, [{
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['children', 'style', 'visible', 'display']);

	      var hasSegmentedControls = typeof children === 'object' && children.type === _SegmentedControl2['default'];

	      var styles = this.styles;
	      if (hasSegmentedControls) {
	        styles = (0, _Styling.mergeStyles)(styles, this.styles.segmentedControls);
	      }
	      ...
	      return _react2['default'].createElement(
	        'div',
	        _extends({}, props, { style: (0, _Styling.applyStyle)(styles) }),
	        this.props.children
	      );
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SegmentedControlItem = __webpack_require__(183);

	var _SegmentedControlItem2 = _interopRequireDefault(_SegmentedControlItem);

	var _SegmentedControlTabs = __webpack_require__(184);
	...
	var SegmentedControl = (function (_Component) {
	  ...
	  _createClass(SegmentedControl, null, [{
	    key: 'Item',
	    value: _SegmentedControlItem2['default'],
	    enumerable: true
	  }, {
	    key: 'propTypes',
	    value: {
	  ...
	  function SegmentedControl(props) {
	    ...
	    _get(Object.getPrototypeOf(SegmentedControl.prototype), 'constructor', this).call(this);
	    this.state = { visible: props.visible !== false, display: props.display !== false };
	  }
	  ...
	  _createClass(SegmentedControl, [{
	    ...
	    value: function render() {
	      ...
	      children = _react.Children.map(children, (function (child, index) {
	        return (0, _react.cloneElement)(child, { control: this, tabId: index });
	      }).bind(this));

	      var tabs = _react2['default'].createElement(_SegmentedControlTabs2['default'], { ref: 'tabs', tabs: children });
	      ...
	      return _react2['default'].createElement(
	        'div',
	        _extends({ style: (0, _Styling.applyStyle)(styles), ref: 'element' }, props),
	        tabs,
	        children
	      );
	    }
	...
	var Item = (function (_Component) {
	  ...
	  _createClass(Item, [{
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['control', 'style', 'title', 'children', 'selected', 'visible', 'display']);

	      var content = this.state.selected ? children : '';
	  ...
	  _createClass(Tabs, [{
	    ...
	    value: function render() {
	      ...
	      for (var i = 0, len = this.props.tabs.length; i < len; ++i) {
	        var props = this.props.tabs[i].props;
	        if (i === 0) {
	        ...
	        tabs = [].concat(_toConsumableArray(tabs), [_react2['default'].createElement(_Tab2['default'], _extends({ ref: props.tabId, item: this.props.tabs[i], key: i }, props))]);
	      }
	...
	var Tab = (function (_Component) {
	  ...
	  _createClass(Tab, null, [{
	    ...
	    value: {
	      ...
	      nextSelected: _react.PropTypes.bool,
	  ...
	  _createClass(Tab, [{
	    ...
	    value: function render() {
	      ...
	      if (this.props.firstChild) {
	        styles = (0, _Styling.mergeStyles)(styles, this.styles.firstChild);
	      }

	      if (this.props.lastChild) {
	        styles = (0, _Styling.mergeStyles)(styles, this.styles.lastChild);
	      }

	      if (this.props.nextSelected) {
	        styles = (0, _Styling.mergeStyles)(styles, this.styles.nextSelected);
	      }

	      if (this.state.selected && this.state.windowFocused) {
	        styles = (0, _Styling.mergeStyles)(styles, this.styles.selected);
	        if (this.props.firstChild) {
	          styles = (0, _Styling.mergeStyles)(styles, { paddingLeft: '11px' });
	        }
	        if (this.props.lastChild) {
	          styles = (0, _Styling.mergeStyles)(styles, { borderRightWidth: '1px', paddingRight: '11px' });
	        }
	        activeStyle = this.styles.selected[':active'];
	      } else if (this.state.selected) {
	        styles = (0, _Styling.mergeStyles)(styles, this.styles.selectedUnfocused);
	        if (this.props.firstChild) {
	          styles = (0, _Styling.mergeStyles)(styles, { paddingLeft: '11px' });
	        }
	        if (this.props.lastChild) {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        {
	          ...
	          'data-active-style': (0, _Styling.parseStyle)(activeStyle)
	        },
	        this.props.title
	      );
	    }
	    ...
	    key: 'styles',
	    get: function get() {
	      return (0, _Styling.mergeStyles)(styles.osx_10_11);
	    }
	  }]);

	  var _Tab = Tab;
	  Tab = (0, _Styling2['default'])(Tab) || Tab;
	  Tab = (0, _WindowState2['default'])(Tab) || Tab;
	  return Tab;
	})(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IndeterminateCircularProgressIndicator = (function (_Component) {
	  _inherits(IndeterminateCircularProgressIndicator, _Component);

	  _createClass(IndeterminateCircularProgressIndicator, null, [{
	    key: 'propTypes',
	    value: {
	      style: _react.PropTypes.object,
	      form: _react.PropTypes.any,
	  ...
	  function IndeterminateCircularProgressIndicator(props) {
	    _classCallCheck(this, _IndeterminateCircularProgressIndicator);

	    _get(Object.getPrototypeOf(_IndeterminateCircularProgressIndicator.prototype), 'constructor', this).call(this);
	    this.framerate = 60;
	    this.duration = 1800;
	    this.state = { visible: props.visible !== false, display: props.display !== false };
	  }

	  _createClass(IndeterminateCircularProgressIndicator, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      this.animate();
	      if (_reactDom2['default'].findDOMNode(this).previousSibling) {
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['style', 'absolute', 'visible', 'display', 'form']);
	      ...
	      if (absolute) {
	        styles = (0, _Styling.mergeStyles)(styles, this.styles.absolute);
	      }

	      var svg = _react2['default'].createElement(
	        'svg',
	        _extends({ ref: 'element', x: '0px', y: '0px', viewBox: '0 0 32.3 32.3', style: (0, _Styling.applyStyle)(styles) }, props),
	        _react2['default'].createElement('path', {
	          ref: '0',
	          fill: '#000000',
	      ...
	      if (absolute) {
	        content = _react2['default'].createElement(
	          'div',
	          { style: (0, _Styling.applyStyle)(this.styles.container) },
	          svg
	        );
	      }
	  ...
	  var _IndeterminateCircularProgressIndicator = IndeterminateCircularProgressIndicator;
	  IndeterminateCircularProgressIndicator = (0, _Styling2['default'])(IndeterminateCircularProgressIndicator) || IndeterminateCircularProgressIndicator;
	  return IndeterminateCircularProgressIndicator;
	})(_react.Component);

	exports['default'] = IndeterminateCircularProgressIndicator;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FormRow = __webpack_require__(188);

	var _FormRow2 = _interopRequireDefault(_FormRow);

	var _Label = __webpack_require__(189);

	var _Label2 = _interopRequireDefault(_Label);

	var _FormRowWrapper = __webpack_require__(190);
	...
	var Form = (function (_Component) {
	  ...
	  _createClass(Form, [{
	    ...
	    value: function registerRow(row) {
	      this.rows = [].concat(_toConsumableArray(this.rows), [row]);
	    }
	  }, {
	    key: 'registerLabel',
	    value: function registerLabel(label) {
	      this.labels = [].concat(_toConsumableArray(this.labels), [label]);
	      this.applyWithToLabels();
	      this.applyWithToRows();
	    }
	  }, {
	    key: 'applyWithToLabels',
	    value: function applyWithToLabels() {
	      var maxWidth = 0;
	      var labels = [];
	      var _iteratorNormalCompletion = true;
	      var _didIteratorError = false;
	      ...
	      try {
	        for (var _iterator = this.labels[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          ...
	          label = _reactDom2['default'].findDOMNode(label);
	          labels = [].concat(_toConsumableArray(labels), [label]);
	          maxWidth = label.offsetWidth > maxWidth ? label.offsetWidth : maxWidth;
	        }
	      } catch (err) {
	        _didIteratorError = true;
	        _iteratorError = err;
	    ...
	    key: 'applyWithToRows',
	    value: function applyWithToRows() {
	      var maxWidth = 0;
	      var rows = [];

	      for (var prop in this.refs) {
	        if (this.refs.hasOwnProperty(prop)) {
	          var row = _reactDom2['default'].findDOMNode(this.refs[prop]);
	          rows = [].concat(_toConsumableArray(rows), [row]);
	          maxWidth = row.offsetWidth > maxWidth ? row.offsetWidth : maxWidth;
	        }
	      }
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['onSubmit', 'children', 'style']);

	      children = _react.Children.map(children, (function (element, index) {
	        var isLast = index + 1 === _react.Children.count(children);
	        if (isLast) {
	          element = (0, _react.cloneElement)(element, {
	            style: (0, _Styling.mergeStyles)({}, element.props.style, { marginBottom: '0' })
	          });
	        }

	        if (element.type === _FormRow2['default']) {
	          var ref = 'row-' + index;
	          return _react2['default'].createElement(
	            _FormRowWrapper2['default'],
	            { ref: ref, style: style },
	            (0, _react.cloneElement)(element, { form: this })
	          );
	        } else if (element.type === _Label2['default']) {
	          var ref = 'label-' + index;
	          return _react2['default'].createElement(
	            _FormRowWrapper2['default'],
	            { ref: ref, style: this.styles.label },
	            (0, _react.cloneElement)(element, { form: this })
	          );
	        }
	        return element;
	      ...
	      return _react2['default'].createElement(
	        'form',
	        _extends({}, props, { onSubmit: this.submit.bind(this), style: (0, _Styling.applyStyle)(this.styles) }),
	        children
	      );
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TextField = __webpack_require__(180);

	var _TextField2 = _interopRequireDefault(_TextField);

	var _PushButton = __webpack_require__(179);
	...
	var Row = (function (_Component) {
	  ...
	  _createClass(Row, [{
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['children', 'style', 'form', 'display', 'visible']);

	      var isButtonsRow = null;

	      children = _react.Children.map(children, (function (element, index) {
	        if (element.type === _Label2['default']) {
	          isButtonsRow = false;
	        } else if (element.type === _TextField2['default']) {
	          isButtonsRow = false;
	        } else if (element.type === _PushButton2['default'] && isButtonsRow === null) {
	          isButtonsRow = true;
	        }
	        return (0, _react.cloneElement)(element, { form: form, row: this });
	      }).bind(this));

	      var styles = this.styles;
	      if (isButtonsRow) {
	        styles = (0, _Styling.mergeStyles)(styles, this.styles.buttonRow);
	      }
	...
	var Label = (function (_Component) {
	  ...
	  _createClass(Label, [{
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['children', 'style', 'color', 'row', 'form', 'align', 'display', 'visible']);
	      ...
	      if (color) {
	        ...
	        styles = (0, _Styling.mergeStyles)(styles, { color: color });
	      }

	      if (row) {
	        styles = (0, _Styling.mergeStyles)(styles, this.styles.rowLabel);
	      }

	      if (align) {
	        styles = (0, _Styling.mergeStyles)(styles, { textAlign: align });
	      }
	      ...
	      return _react2['default'].createElement(
	        'div',
	        _extends({ ref: 'label' }, props, { style: (0, _Styling.applyStyle)(styles) }),
	        children
	      );
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RowWrapper = (function (_Component) {
	  _inherits(RowWrapper, _Component);

	  function RowWrapper() {
	    _classCallCheck(this, RowWrapper);

	    _get(Object.getPrototypeOf(RowWrapper.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(RowWrapper, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        _extends({ ref: 'element', style: style }, props),
	        children
	      );
	    }
	  }, {
	    ...
	    get: function get() {
	      ...
	      _react.Children.map(this.props.children, function (child, index) {
	        if (child.type === _Row2['default']) {
	          _react.Children.map(child.props.children, function (child, index) {
	            if (child.type === _Label2['default']) {
	              labels = [].concat(_toConsumableArray(labels), [child]);
	            }
	          });
	        }
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDesktopLibWindows = __webpack_require__(192);
	...
	var _default = (function (_Component) {
	  ...
	  _createClass(_default, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        _reactDesktopLibWindows.Window,
	        { chrome: true },
	        _react2['default'].createElement(_reactDesktopLibWindows.TitleBar, { title: 'Windows', controls: true })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Window = Window;
	var TitleBar = __webpack_require__(172);
	exports.TitleBar = TitleBar;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WindowWindows = (function (_Component) {
	  _inherits(WindowWindows, _Component);

	  _createClass(WindowWindows, null, [{
	    key: 'propTypes',
	    value: {
	      children: _react.PropTypes.oneOfType([_react2['default'].PropTypes.string, _react2['default'].PropTypes.element, _react2['default'].PropTypes.array]),
	      style: _react.PropTypes.object,
	  ...
	  function WindowWindows(props) {
	    _classCallCheck(this, _WindowWindows);

	    _get(Object.getPrototypeOf(_WindowWindows.prototype), 'constructor', this).call(this);
	    this.state = {
	      windowFocused: true,
	      visible: props.visible !== false,
	      display: props.display !== false
	  ...
	  _createClass(WindowWindows, [{
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['style', 'border', 'chrome', 'children', 'visible', 'display']);
	      ...
	      var titleBar = _react.Children.map(children, (function (element, index) {
	        if (element.type === _TitleBar2['default'] || element.type === _TitleBarTitleBarWindows2['default']) {
	          return element;
	        }
	      }).bind(this));
	      ...
	      if (border) {
	        styles = (0, _Styling.mergeStyles)(styles, { borderColor: border });
	      }
	  ...
	  var _WindowWindows = WindowWindows;
	  WindowWindows = (0, _WindowState2['default'])(WindowWindows) || WindowWindows;
	  return WindowWindows;
	})(_react.Component);

	exports['default'] = WindowWindows;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _OsToggleScss = __webpack_require__(195);

	var _OsToggleScss2 = _interopRequireDefault(_OsToggleScss);
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'switch' },
	          _react2['default'].createElement('input', { ref: 'switch', id: 'toggle', type: 'checkbox', onChange: this.change.bind(this) }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./OsToggle.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./OsToggle.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".toggle {\n  background: rgba(255, 255, 255, 0.4);\n  display: -ms-flexbox;\n  display: -webkit-flex;\n  display: flex;\n  -webkit-align-items: center;\n  -ms-flex-align: center;\n  align-items: center;\n  -webkit-justify-content: center;\n  justify-content: center;\n  width: 200px;\n  border-radius: 42px;\n  border: 1px solid rgba(255, 255, 255, 0.8); }\n  .toggle .option {\n    -webkit-user-select: none;\n    -moz-user-select: none;\n    -ms-user-select: none;\n    user-select: none;\n    font-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n    font-size: 12px;\n    width: 50px;\n    text-align: right;\n    cursor: default;\n    color: #333; }\n    .toggle .option:last-of-type {\n      text-align: left; }\n  .toggle .switch {\n    display: table-cell;\n    vertical-align: middle;\n    padding: 6px 10px; }\n    .toggle .switch input {\n      position: absolute;\n      margin-left: -9999px;\n      visibility: hidden; }\n    .toggle .switch input + label {\n      display: block;\n      position: relative;\n      cursor: pointer;\n      outline: none;\n      -webkit-user-select: none;\n      -moz-user-select: none;\n      -ms-user-select: none;\n      user-select: none;\n      padding: 2px;\n      width: 30px;\n      height: 12px;\n      background-color: #008ffe;\n      border-radius: 18px; }\n    .toggle .switch input + label:before,\n    .toggle .switch input + label:after {\n      display: block;\n      position: absolute;\n      top: 1px;\n      left: 1px;\n      bottom: 1px;\n      content: \"\"; }\n    .toggle .switch input + label:before {\n      right: 1px;\n      background: rgba(255, 255, 255, 0.9);\n      border-radius: 12px;\n      transition: background 0.4s; }\n    .toggle .switch input + label:after {\n      width: 14px;\n      background: -moz-linear-gradient(top, #008ffe, #0079d7);\n      background: -webkit-linear-gradient(top, #008ffe, #0079d7);\n      background: -ms-linear-gradient(top, #008ffe, #0079d7);\n      background: linear-gradient(top, #008ffe, #0079d7);\n      border-radius: 100%;\n      box-shadow: 0 2px 5px rgba(0, 0, 0, 0.3), inset 0 -1px 0 rgba(0, 0, 0, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.05);\n      transition: margin 0.4s; }\n    .toggle .switch input:checked + label:after {\n      margin-left: 19px; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HeaderScss = __webpack_require__(203);
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
